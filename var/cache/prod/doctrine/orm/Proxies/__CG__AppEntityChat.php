...
class Chat extends \App\Entity\Chat implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Chat' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Chat' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Chat' . "\0" . 'genre', '' . "\0" . 'App\\Entity\\Chat' . "\0" . 'chaton', '' . "\0" . 'App\\Entity\\Chat' . "\0" . 'photos', '' . "\0" . 'App\\Entity\\Chat' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Chat' . "\0" . 'text'];
        }
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\Chat
    {
     ...
     * {@inheritDoc}
     */
    public function setGenre(bool $genre): \App\Entity\Chat
    {
    ...
    public function getChaton(): ?bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getChaton', []);

        return parent::getChaton();
    }

    /**
     * {@inheritDoc}
     */
    public function setChaton(bool $chaton): \App\Entity\Chat
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setChaton', [$chaton]);

        return parent::setChaton($chaton);
    }
     ...
     * {@inheritDoc}
     */
    public function addPhoto(\App\Entity\Photo $photo): \App\Entity\Chat
    {
     ...
     * {@inheritDoc}
     */
    public function removePhoto(\App\Entity\Photo $photo): \App\Entity\Chat
    {
     ...
     * {@inheritDoc}
     */
    public function setTitle(string $title): \App\Entity\Chat
    {
     ...
     * {@inheritDoc}
     */
    public function setText(string $text): \App\Entity\Chat
    {
